...
export interface AnimatedAuthPageProps {
      ...
      >
        <div className="w-full max-w-105">
          ...
          <div className="text-center mb-10 transition-all duration-300">
            <h1
              className={cn(
                'text-4xl font-bold tracking-tight mb-2 font-handwriting transition-all duration-300',
                mode === 'login' ? 'text-foreground' : 'text-primary',
              )}
            >
              {mode === 'login' ? 'Hey Buddyyy !!' : 'Join Us Today !!'}
            </h1>
            <p className="text-muted-foreground text-sm">
              {mode === 'login' ? 'Please enter your details' : 'Create your account'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full h-12 text-base font-medium font-handwriting" size="lg" disabled={isLoading}>
              {isLoading
                ? mode === 'login'
                  ? 'Signing in...'
                  : 'Creating account...'
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            {mode === 'login' ? (
              <>
                Don't have an account buddy?{' '}
                <button onClick={switchMode} className="text-foreground font-medium hover:underline font-handwriting">
                  Sign up
                </button>
              </>
            ) : (
